...
export function Starting() {
    ...
    return (
        <div className="pointer-events-none absolute inset-0 cursor-default select-none backdrop-saturate-[0.35]">
            <BrowserView>
                <div className="absolute inset-0 flex h-min justify-center pt-16">
            ...
            <MobileView>
                <div className="absolute inset-0 flex h-min justify-center pt-4">
