...
export type RocketEntity = EntityWith<
    RuntimeComponents,
    (typeof RocketEntityComponents)[number]
>
...
export function updateCurrentLevel(
    ...
    entity.components.rocket.currentLevel.components.level.boundsCollider.setSensor(
        true,
    )
    ...
    entity.components.rocket.spawnPosition =
        entity.components.rigidBody.translation()
    entity.components.rocket.spawnRotation =
