...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1a7f0affd6166340: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h4b83f81b31de4b09: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h171d7fb522e397e6: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h4965dd5ec452a737: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h6f6aada71531b208: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hd051c02be305827c: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hef91b7164d2378f1: (a: number, b: number, c: number) => void;
