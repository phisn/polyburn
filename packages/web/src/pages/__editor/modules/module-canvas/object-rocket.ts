...
export class ObjectRocket extends THREE.Object3D {
    private svg: Svg
    ...
    constructor(opacity?: number) {
        ...
        this.svg.scale.set(scale, scale, 1.0)
        this.svg.rotation.set(0, 0, Math.PI)
        this.svg.position.set(rocketEntry.width / 2, rocketEntry.height / 2, 1.0)
