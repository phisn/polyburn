...
use self::base_instancing::{InstancingChild, InstancingPlugin};

pub mod base_broad_phase;
mod base_instancing;
mod gradient;
...
pub struct ParticleSystemBundle {
    ...
    pub instancing_host: base_instancing::InstancingHost,
...
pub fn particle_system_event_receiver(
    ...
    for event in events.read() {
        if let Ok(mut particle_system) = particle_systems.get_mut(event.system_entity) {
            ...
            commands
                .entity(event.system_entity)
                .remove::<ParticleSystemIdle>();
        } else {
            ...
            for i in 0..count {
                ...
                commands.entity(entity).with_children(|parent| {
                    parent.spawn((
                        ...
                        bevy_xpbd_2d::prelude::RigidBody::Dynamic,
                        bevy_xpbd_2d::prelude::Collider::ball(size),
                        bevy_xpbd_2d::prelude::LockedAxes::ROTATION_LOCKED,
                        bevy_xpbd_2d::prelude::LinearVelocity(velocity),
                        bevy_xpbd_2d::prelude::GravityScale(0.0),
                        bevy_xpbd_2d::prelude::CollisionLayers::none()
                            .add_group(ParticlePhysicsLayer::Particle)
                            .add_mask(ParticlePhysicsLayer::Object),
                    ));
                });
            }
        }
